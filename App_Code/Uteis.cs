...
public class Uteis
{
    ...
    public static void GeraMarcaDagua(Image image, Image watermarkImage, String URLsaida, Int32 Width, Int32 Height)
    {
    ...
    public static void GeraMarcaDagua(String URLimagem, String URLlogo, String URLsaida, Int32 Width, Int32 Height)
    {

        using (Image image = Image.FromFile(URLimagem))
        using (Image watermarkImage = Image.FromFile(URLlogo))
            GeraMarcaDagua(image, watermarkImage, URLsaida, 900, 600);
